...
?>
    ...
    $pdoStat = $linkpdo->prepare('DELETE FROM patient WHERE id_patient=:id_patient LIMIT 1');
    ...
    if ($executeIsOk) {
        $message = "L'usager a été supprimé";
    } else {
        $message = "Echec de la suppression de l'usager";
    }
    ...
    <head>
        ...
        <title>Suppression de l'usager</title>
